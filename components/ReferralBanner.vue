    ...
    copy() {
      try {
        navigator.clipboard.writeText(
          `Let's play together? 🤑 BitcyBets —  ${this.link}`
        )
      } catch {}
