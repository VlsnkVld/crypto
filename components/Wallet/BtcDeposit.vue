<template>
  <div>
    ...
    <!-- Our BTC address -->
    <span class="font-weight-medium">Our {{ paymethod.iso }} address</span>
    <v-text-field class="mt-2" outlined :value="paymethod.address" readonly>
    ...
    <v-row>
      <v-col>
        <span class="font-weight-medium">
          Value
          <span class="primary--text">{{ paymethod.iso }}</span>
        </span>
